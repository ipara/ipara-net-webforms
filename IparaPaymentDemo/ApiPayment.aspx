<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApiPayment.aspx.cs" Inherits="IparaPaymentDemo.ApiPayment" %>
...
<form action="" method="post" class="form-horizontal">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input value="5456165456165454" id="cardNumber" class="form-control input-md" runat="server">
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<asp:Button ID="BtnApiPayment" runat="server" Text="ApiPayment Ödeme" class="btn btn-success" OnClick="BtnApiPayment_Click" />
		</div>
	</div>
</form>
